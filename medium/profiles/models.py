...
class Profile(models.Model):
    ...
    profile_pic = models.ImageField(upload_to=get_profile_pic_url)
    header_pic = models.ImageField(upload_to=get_header_pic_url)
    ...
    def __str__(self):
        return f"{self.user.username or self.user.name}'s profile"
